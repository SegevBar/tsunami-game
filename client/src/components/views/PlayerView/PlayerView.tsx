import { GameSession, PlayerHand } from '../../../types';
import { PlayerLobby, PlayerGameControls, GameFinished } from '../../game';
...
export function PlayerView({ session, playerName, hand }: PlayerViewProps) {
